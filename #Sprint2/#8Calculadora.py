...
boton0.connect("clicked", controlador.ha_pulsado_0)
boton1 = builder.get_object("button1")
boton1.connect("clicked", controlador.ha_pulsado_1)
boton2 = builder.get_object("button2")
boton2.connect("clicked", controlador.ha_pulsado_2)
boton3 = builder.get_object("button3")
boton3.connect("clicked", controlador.ha_pulsado_3)
boton4 = builder.get_object("button4")
boton4.connect("clicked", controlador.ha_pulsado_4)
boton5 = builder.get_object("button5")
boton5.connect("clicked", controlador.ha_pulsado_5)
boton6 = builder.get_object("button6")
boton6.connect("clicked", controlador.ha_pulsado_6)
boton7 = builder.get_object("button7")
boton7.connect("clicked", controlador.ha_pulsado_7)
boton8 = builder.get_object("button8")
boton8.connect("clicked", controlador.ha_pulsado_8)
boton9 = builder.get_object("button9")
boton9.connect("clicked", controlador.ha_pulsado_9)
...
boton_dividir.connect("clicked", controlador.ha_pulsado_dividir)
boton_multiplicar = builder.get_object("button_multiply")
boton_multiplicar.connect("clicked", controlador.ha_pulsado_multiplicar)
boton_sumar = builder.get_object("button_plus")
boton_sumar.connect("clicked", controlador.ha_pulsado_sumar)
boton_restar = builder.get_object("button_minus")
boton_restar.connect("clicked", controlador.ha_pulsado_restar)
boton_igual = builder.get_object("button_equals")
boton_igual.connect("clicked", controlador.ha_pulsado_igual)
